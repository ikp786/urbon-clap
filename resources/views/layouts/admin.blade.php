    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
                    ...
                    <a class="navbar-brand justify-content-center" href="{{ route('home') }}">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                                ...
                                <img style="max-height: 50px; max-width:50px; " src="{{ asset('public/admin_assets/images/logo-icon.png') }}" class="dark-logo" width="158px" alt="Urbon Clap">
        ...
        <div class="page-wrapper" style="min-height:100vh;">
            ...
            <footer class="text-center">
                © 2020 Monster Admin by <a href="https://www.jploft.com/">Jploft</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
