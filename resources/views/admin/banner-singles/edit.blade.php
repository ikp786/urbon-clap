...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="{{ route('banner-singles.index') }}" class="btn btn-primary">Back to List</a>
        @endcan
        <form method="POST" action="{{ route('banner-singles.update', $banner->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')                      
